...
urlpatterns = [
    ...
    path("<int:session_id>/voice_interaction/", views.voice_interaction_api, name="voice_interaction_api"),
    path("<int:session_id>/download_pdf/", views.download_pdf_report, name="download_pdf"),
